...
- **After each implementation, check for any SOLID, hexagonal architectural violations, and check if tui and engine have no leaky abstractions, doc comments, run tests, and pre-commit.sh.**
