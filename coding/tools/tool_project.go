...
func (t *ProjectTaskAddTool) Definition() llm.ToolDef {
	return llm.ToolDef{
		...
		Function: llm.FunctionDef{
			...
			Description: "Append a new `- [ ]` task to /project.md under the given phase and feature. Phase is matched by case-insensitive substring; feature is created if absent. Optional `link` is appended to the title as a markdown link.",
