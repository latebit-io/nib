...
// engine-side ports (today: [Highlighter]). The kit module does not
// import engine (engine sits to the side of the foundation→kit→coding→tui
// spine, consumed by coding and tui), so fixtures for engine ports live
// here rather than under kit.
//
