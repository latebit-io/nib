...
const (
	...
	ActionAgentAlwaysAllow = keymap.ActionAgentAlwaysAllow
...
func DefaultKeymap() *Keymap {
	km := &Keymap{
		bindings: map[keyBinding]Action{
			...
			{code: 'a', mod: tea.ModAlt}:  ActionAgentAlwaysAllow,
			{code: 'å', mod: 0}:           ActionAgentAlwaysAllow, // macOS: Option+A sends å
		...
		byString: map[string]Action{
			...
			"alt+a":    ActionAgentAlwaysAllow,
			"å":        ActionAgentAlwaysAllow, // macOS: Option+A sends å
